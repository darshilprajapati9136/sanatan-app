          ...
          <div className="w-full space-y-6">
            ...
            <div className="p-6 sm:p-10 rounded-3xl bg-gradient-to-b from-neutral-900/80 to-neutral-950 border border-neutral-800 shadow-2xl backdrop-blur-md flex flex-col items-center text-center relative overflow-hidden">
              ...
              <div className="relative mb-6">
                ...
                >
                  <span className="text-3xl sm:text-4xl font-serif font-bold text-amber-100 group-hover:scale-110 transition-transform">
                    {japaCount}
                  </span>
                  <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-amber-500/90 mt-1">
                    / {japaTarget} Chants
                  </span>
              ...
              {/* Progress bar */}
              <div className="w-full max-w-xs bg-neutral-950 h-2 rounded-full overflow-hidden border border-neutral-800 mb-6">
                <div 
